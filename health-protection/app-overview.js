...
const prePrimaryRows=[
  {
    item:tr('One-off: pregnancy to age 1, natural birth','一次性：怀孕至1岁，自然产'),
    basic:costLine('S$8k - S$16k',tr('checkups, routine medicine, natural delivery, jaundice, confinement, first-year necessities','产检、常规药物、自然产、黄疸、月子、第一年用品')),
    adv:costLine('S$19k - S$44k',tr('private gynae, private/public delivery mix, nanny, new gear and formula','私人妇产科、公私立分娩组合、月嫂、新用品及奶粉')),
    lux:costLine('S$61k - S$102k+',tr('senior private care, private 1-bed, confinement centre and premium baby setup','资深私人医疗、私人1人房、月子中心及高端宝宝用品'))
  },
  {
    item:tr('One-off: pregnancy to age 1, C-section','一次性：怀孕至1岁，剖腹产'),
    basic:costLine('S$9k - S$18k',tr('same basket, using subsidised C-section median examples','同一篮子，按津贴剖腹产中位数例子')),
    adv:costLine('S$23k - S$49k',tr('same basket, using public B1/private or private 2-bed examples','同一篮子，按公立B1/私人或私人2人房例子')),
    lux:costLine('S$66k - S$108k+',tr('same basket, using private 1-bed/suite-style planning range','同一篮子，按私人1人房/套房式规划区间'))
  },
  {
    item:tr('Baby necessities, first-year average','宝宝用品，第一年月均'),
    basic:costLine('S$417 - S$833/month',tr('about S$5k - S$10k/year','约每年5千至1万新元')),
    adv:costLine('S$833 - S$1,667/month',tr('about S$10k - S$20k/year','约每年1万至2万新元')),
    lux:costLine('S$2,083+/month',tr('about S$25k+/year','约每年2.5万新元以上'))
  },
  {
    item:tr('Childcare monthly burn','托育月度开支'),
    basic:costLine('S$3 - S$746/month net',tr('after AOP/POP subsidies, depending on income and work status','扣AOP/POP津贴后，视收入及工作状态')),
    adv:costLine('S$900 - S$2,000/month net',tr('private preschool after basic subsidy','私人幼儿园扣基本津贴后')),
    lux:costLine('S$2,500 - S$3,500+/month',tr('premium private or international-style preschool','高端私人或国际课程式幼儿园'))
  },
  {
    item:tr('Childcare yearly burn','托育年度开支'),
    basic:costLine('S$36 - S$8,952/year',tr('12 months of the monthly range','按月度区间乘12个月')),
    adv:costLine('S$10,800 - S$24,000/year',tr('12 months of the monthly range','按月度区间乘12个月')),
    lux:costLine('S$30,000 - S$42,000+/year',tr('12 months of the monthly range','按月度区间乘12个月'))
  },
  {
    item:tr('Childcare total before Primary 1','上小学前托育总额'),
    basic:costLine('S$210 - S$52k',tr('about 70 months from 2 months old to age 6','约70个月，从2个月大至6岁')),
    adv:costLine('S$63k - S$140k',tr('about 70 months from 2 months old to age 6','约70个月，从2个月大至6岁')),
    lux:costLine('S$175k - S$245k+',tr('about 70 months from 2 months old to age 6','约70个月，从2个月大至6岁'))
  },
  {
    item:tr('All-in before Primary 1, natural birth','上小学前总额，自然产'),
    basic:costLine('S$8k - S$69k',tr('one-off natural birth path plus childcare total','自然产一次性成本加托育总额')),
    adv:costLine('S$82k - S$184k',tr('one-off natural birth path plus childcare total','自然产一次性成本加托育总额')),
    lux:costLine('S$236k - S$347k+',tr('one-off natural birth path plus childcare total','自然产一次性成本加托育总额'))
  },
  {
    item:tr('All-in before Primary 1, C-section','上小学前总额，剖腹产'),
    basic:costLine('S$9k - S$70k',tr('one-off C-section path plus childcare total','剖腹产一次性成本加托育总额')),
    adv:costLine('S$86k - S$189k',tr('one-off C-section path plus childcare total','剖腹产一次性成本加托育总额')),
    lux:costLine('S$241k - S$353k+',tr('one-off C-section path plus childcare total','剖腹产一次性成本加托育总额'))
  }
];
return head(tr('Cost of Raising a Child in Singapore','在新加坡养育孩子的成本'),
  ...
  <div class="compare-wrap"><table class="compare cost">
    <tr>
      <th>${tr('Before Primary School tally','小学前成本合计')}</th>
      <th>${tr('Basic','基础')}</th>
      <th>${tr('Advanced','进阶')}</th>
      <th>${tr('Luxury','高端')}</th>
    </tr>
    ${prePrimaryRows.map(r=>`<tr>
      <td>${star(r.item, r.item.includes('All-in') || r.item.includes('总额') ? 'important' : '')}</td>
      <td>${r.basic}</td>
      <td>${r.adv}</td>
      <td>${r.lux}</td>
    </tr>`).join('')}
